...
const I18N = {
  en: {
    ...
    'studio.sub': "We're <strong>Maraverse Games</strong> — a one-person indie studio making collection and adventure games about the real and imagined worlds worth knowing. Our first one is here: <strong>Wildlife Collection</strong>.",
  ...
  es: {
    ...
    'studio.sub': 'Somos <strong>Maraverse Games</strong>, un estudio indie en solitario que crea juegos de colección y aventura sobre los mundos —reales e imaginados— que merece la pena conocer. El primero ya está aquí: <strong>Wildlife Collection</strong>.',
    ...
    'studio.story.p2': 'Durante mucho tiempo, eso sí, no pudo pasar de ahí: un hobby. Crear algo como Wildlife Collection — más de <strong>2.600 ilustraciones de animales realistas y revisadas a mano</strong> — era sencillamente imposible de dibujar o pagar para una sola persona. Entonces la IA cambió las cuentas, y desde finales de 2023 por fin puedo construir yo solo los mundos que antes solo imaginaba.',
